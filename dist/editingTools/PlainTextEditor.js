...
var PlainTextEditor = /*#__PURE__*/function (_React$Component) {
  _inherits(PlainTextEditor, _React$Component);

  var _super = _createSuper(PlainTextEditor);
  ...
  function PlainTextEditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleEditorChange", function (event) {
      var newContent = {
